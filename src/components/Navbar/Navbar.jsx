...
const PremiumNavbar = ({ onLogout }) => {
  ...
  const user = { 
    displayName: 'Admin Transita', 
    photoURL: 'https://ui-avatars.com/api/?name=Admin+Transita&background=16a34a&color=fff&bold=true' 
  };
      ...
      <header className="premium-navbar">
        <div className="navbar-logo-container">
          ...
          <div className="navbar-brand">
            <span className="navbar-brand-name">Transita.IA</span>
            <span className="navbar-brand-subtitle">Soluções de Transporte</span>
          </div>
        </div>
        ...
        <div className="navbar-actions">
          ...
          >
            <img 
              ...
              onError={(e) => {
                e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(user.displayName)}&background=16a34a&color=fff`;
              }}
            />
